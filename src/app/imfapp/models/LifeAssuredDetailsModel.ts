export interface LifeAssuredDetailsModel {
  LifeAssured?: string; // Original label: Policy Holder/Proposer
  LifeAssuredDob?: string; // Original label: Proposer DOB (ISO date string)
...
export class LifeAssuredDetails implements LifeAssuredDetailsModel {
  ...
  constructor(init?: Partial<LifeAssuredDetailsModel>) {
